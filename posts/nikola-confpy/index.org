#+BEGIN_COMMENT
.. title: Nikola Conf.py
.. slug: nikola-confpy
.. date: 2023-06-20 15:42:22 UTC-07:00
.. tags: nikola
.. category: Nikola
.. link: 
.. description: The Nikola conf.py file.
.. type: text
...
#+begin_src python :noweb-ref site-data
...
#+begin_src python :noweb-ref post-formats
POSTS = (
...
#+begin_src python :noweb-ref pages
PAGES = (
...
#+begin_src python :noweb-ref index-path
...
#+begin_src python :noweb-ref navigation-links
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/posts/", "Posts"),
...
#+begin_src python :noweb-ref github-deploy
...
#+begin_src python :noweb-ref the-license
LICENSE = '''
...
#+begin_src python :noweb-ref content-footer
...
#+begin_src python :noweb-ref strip-indexes
...
#+begin_src python :noweb-ref search-form
